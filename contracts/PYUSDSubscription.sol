...
contract PYUSDSubscription is Ownable, ReentrancyGuard, Pausable {
    ...
    /**
     * @dev Cancel subscription with full refund
     * @notice Refunds the full subscription plan price upon cancellation
     */
    function cancelSubscription() external nonReentrant {
        ...
        // Calculate refund: always refund the plan price
        uint256 refundAmount = plan.price;
